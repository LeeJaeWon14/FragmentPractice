...
class VariableFragment : Fragment() {
    ...
    companion object {
        fun newInstance(page : Int) : VariableFragment {
            val fragment = VariableFragment()
            val args = Bundle()
    ...
    override fun onAttach(context: Context) {
        ...
        if(context is Activity) act = (context as MainActivity)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.thumbnail.setImageURI(act!!.uriList[requireArguments().getInt("page")])
    }
